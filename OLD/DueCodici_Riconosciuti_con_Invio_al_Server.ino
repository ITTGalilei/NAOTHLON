...
char server[] = "192.168.1.34";    // name address for Google (using DNS)
...
void loop() {
  ...
  if (RC522.isCard())
  {
    ...
    if (codiceLetto.equals("D326617A0")) {
      nome=" Alessandro";
      invioDati();
    }
    else if (codiceLetto.equals("AC77E92B19")) {
      nome=" Mario";
      invioDati();
    }
    else {
